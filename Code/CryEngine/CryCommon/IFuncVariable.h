...
public:
	...
	MFPVariable( FuncParamType type, char* _humanname, char* _description, T* obj, OpticsBase_MFPtr setter, OpticsBase_MFPtr getter )
	{
		Set(type, _humanname, _description, obj, setter, getter);
	}

	void Set( FuncParamType type, char* _humanname, char* _description, T* obj, OpticsBase_MFPtr setter, OpticsBase_MFPtr getter )
	{
		paramType = type;
