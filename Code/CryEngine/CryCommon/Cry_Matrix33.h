...
template<typename F> struct __passinreg Matrix33_tpl
{
	...
	//CONSTRUCTOR for different types. It initializes a Matrix33 by converts store 3 vectors into the columns. 
	//Matrix33(v0,v1,v2);
	...
	//CONSTRUCTOR for different types. It initializes a Matrix33 by converts store 3 vectors into the columns and concverts between floats/doubles. 
	//Matrix33r(v0,v1,v2);
	...
	//CONSTRUCTOR for different types. It converts a Diag33 into a Matrix33. 
	//Matrix33(diag33);
	...
	//CONSTRUCTOR for different types. It converts a Diag33 into a Matrix33 and also converts between double/float. 
	//Matrix33(diag33);
	...
	//CONSTRUCTOR for different types. It converts a Matrix34 into a Matrix33. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix34 into a Matrix33 and converts between double/float. 
	//Needs to be 'explicit' because we loose the translation vector in the conversion process 
	//Matrix33(m34r);
	...
	//CONSTRUCTOR for different types. It converts a Matrix44 into a Matrix33. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix44 into a Matrix33 and converts between double/float. 
	//Needs to be 'explicit' because we loose the translation vector and the 3rd row in the conversion process 
	//Matrix33(m44r);
	...
	//CONSTRUCTOR for different types. It converts a Matrix34A into a Matrix33. 
	//Needs to be 'explicit' because we loose the translation vector in the conversion process 
	//Matrix33(m34A);
	explicit ILINE Matrix33_tpl<F>(const Matrix34A_tpl<F>& m )	
	{
		assert(m.IsValid());
		m00=m.m00;		m01=m.m01;		m02=m.m02;	
		m10=m.m10;		m11=m.m11;		m12=m.m12;
	...
	//Needs to be 'explicit' because we loose the translation vector in the conversion process 
	//Matrix33(m34r);
	template<class F1> explicit ILINE Matrix33_tpl<F>(const Matrix34A_tpl<F1>& m )	
	{
		assert(m.IsValid());
		m00=F(m.m00);		m01=F(m.m01);		m02=F(m.m02);	
		m10=F(m.m10);		m11=F(m.m11);		m12=F(m.m12);
	...
	//CONSTRUCTOR for different types. It converts a Matrix44A into a Matrix33. 
	//Needs to be 'explicit' because we loose the translation vector and the 3rd row in the conversion process 
	//Matrix33(m44);
	explicit ILINE Matrix33_tpl<F>(const Matrix44A_tpl<F>& m ) 
	{
		assert(m.IsValid());
		m00=m.m00;	m01=m.m01;	m02=m.m02; 
		m10=m.m10;	m11=m.m11;	m12=m.m12;
	...
	//CONSTRUCTOR for different types. It converts a Matrix44A into a Matrix33r and converts between double/float. 
	//Needs to be 'explicit' because we loose the translation vector and the 3rd row in the conversion process 
	//Matrix33r(m44);
	template<class F1> explicit ILINE Matrix33_tpl<F>(const Matrix44A_tpl<F1>& m ) 
	{
		assert(m.IsValid());
		m00=F(m.m00);	m01=F(m.m01);	m02=F(m.m02); 
		m10=F(m.m10);	m11=F(m.m11);	m12=F(m.m12);
	...
	//CONSTRUCTOR for different types. It converts a Quat into a Matrix33. 
	...
	//CONSTRUCTOR for different types. It converts a Quat into a Matrix33 and converts between double/float. 
	//Needs to be 'explicit' because we loose fp-precision in the conversion process 
	//Matrix33(quatr);
	...
	//CONSTRUCTOR for different types. It converts a Euler Angle into a Matrix33. 
	//Needs to be 'explicit' because we loose fp-precision in the conversion process 
	//Matrix33(Ang3(1,2,3));
	...
	//CONSTRUCTOR for different types. It converts a Euler Angle into a Matrix33 and converts between double/float. . 
	//Needs to be 'explicit' because we loose fp-precision in the conversion process 
