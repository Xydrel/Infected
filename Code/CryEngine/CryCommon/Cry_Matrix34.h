...
template <typename F> struct __passinreg Matrix34_tpl
{
	...
	//--------------------------------------------------------------------
	ILINE Matrix34_tpl<F>(	f32 v00, f32 v01, f32 v02, f32 v03,	f32 v10, f32 v11, f32 v12, f32 v13,	f32 v20, f32 v21, f32 v22, f32 v23)
	{ 		
	...
	//CONSTRUCTOR for different types. It converts a Matrix33 into a Matrix34. 
	//Matrix34(m33);
	...
	//CONSTRUCTOR for different types. It converts a Matrix33 into a Matrix34 and also converts between double/float. 
	//Matrix34(Matrix33);
	template<class F1> ILINE Matrix34_tpl<F>(const Matrix33_tpl<F1>& m)
  {
	...
	//CONSTRUCTOR for different types. It converts a Matrix33 with a translation-vector into a Matrix34. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix33 with a translation-vector into a Matrix34 and also converts between double/float. 
	...
	template<class F1> ILINE Matrix34_tpl<F>( const Matrix34_tpl<F1>& m )
  {
	...
	//CONSTRUCTOR for different types. It converts a Matrix44 into a Matrix34. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix44 into a Matrix34 and converts between double/float. 
	//Needs to be 'explicit' because we loose the translation vector in the conversion process 
	//Matrix34(m44r);
	...
	//CONSTRUCTOR for different types. It converts a Matrix34A into a Matrix34. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix34A into a Matrix34 and converts the floats of the Matrix34A into doubles. 
	//Needs to be 'explicit' because we loose the 16byte alignment in the conversion process 
	//Matrix34r(m34A);
	...
	//CONSTRUCTOR for different types. It converts a Matrix44A into a Matrix34. 
	...
	//CONSTRUCTOR for different types. It converts a Matrix44A into a Matrix34 and converts between double/float. 
	//Needs to be 'explicit' because we loose the translation vector and the 3rd row in the conversion process 
	//Matrix34(m44Ar);
...
typedef Matrix34_tpl<f32> Matrix34A;
#elif defined(DURANGO) || defined(ORBIS)
typedef DEFINE_ALIGNED_DATA(Matrix34_tpl<f32>, Matrix34A, 16); 
#endif
