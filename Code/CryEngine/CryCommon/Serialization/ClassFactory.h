...
#define SERIALIZATION_CLASS(BaseType, Type, name) \
	const Serialization::TypeDescription Type##BaseType##_DerivedDescription(Serialization::TypeID::get<Type>(), #Type, name, sizeof(Type)); \
