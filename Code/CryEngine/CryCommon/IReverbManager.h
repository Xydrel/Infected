...
#define REVERB_TYPE_SOFTWARE 1
#define REVERB_TYPE_SOFTWARE_PREALLOC_BUFFERS 2
...
struct IReverbManager
{
	...
	virtual float GetEnvironment(EntityId const nEntityID, Vec3 const& rPosition) = 0;
