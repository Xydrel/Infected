...
#define _BEFRIEND_CRYCOMPOSITE_QUERY()\
	template <class Src> friend boost::shared_ptr<ICryUnknown> CompositeQuerySemantics::crycomposite_query(Src*, const char*, bool*);\
	template <class Src> friend boost::shared_ptr<const ICryUnknown> CompositeQuerySemantics::crycomposite_query(const Src*, const char*, bool*);\
