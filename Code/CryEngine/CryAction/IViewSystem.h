...
UNIQUE_IFACE struct IView
{
	...
	virtual EntityId GetSoundListenerID() const = 0;
	virtual void SetSoundListenerID(EntityId const nListenerID) = 0;
};
...
UNIQUE_IFACE struct IViewSystem
{
  ...
  virtual void SetListenersActive(bool const bActive) = 0;
};
